  ...
  return (
    ...
    <div className=" mb:h-fit h-screen mb:pt-[100px]  pt-[200px] px-[20px] bg-[#F7F3EE] mb:justify-start  justify-center items-start gap-[5rem] mb:gap-[40px]  w-screen flex flex-col">
      <div className=' leading-[1.2] mb:text-28px   w-[86vw] font-[500] text-[3.6rem]'>
        <span className=' mb:text-12px font-400 pr-[7vw]  text-[1vw]'>{`(VỀ CHÚNG TÔI)`}</span>{paragraph1}
      </div>
      <div className='  w-[100%] flex mb:justify-start justify-end'>
        <div className=' mb:hidden text-aPara  font-p w-[27vw]' >Được thành lập vào năm 2016, Phố Bên Đồi là đơn vị tiên phong trong việc tạo nên nền tảng kết nối và khuyến khích thể hiện nghệ thuật trong cộng đồng tại thành phố Đà Lạt. </div>
        <button  className=' mt-16 pl-[8vw] mb:text-12px mb:pl-0 mb:mt-0 text-[1.1vw] flex gap-3 items-end ' ><img className='h-6 mt-[-0.5vw] object-contain rounded-none w-5' src={require('../../Asset/Nav/buttonLeftArrow.svg').default} alt="" /><Link to={'/aboutus'}><span className=' border-b-[1px] font-bold leading-4 border-black'>CÂU CHUYỆN CỦA CHÚNG TÔI</span></Link>    </button>
    ...
    <div ref={main} className="h-[330vh] mb:h-[168vh]  mb:pt-[100px] pt-[200px]   bg-[#F7F3EE] w-[100vw] gap-1 flex justify-center   "  >
      <div  ref={contain} className='  mb:h-[19rem] mb:overflow-y-hidden  h-[95vh]  w-[98w]  gap-5  overflow-x-hidden flex items-center    '>
     
        <div className=' mb:hidden min-w-[30vw]'></div>
       ...
       <div className='  mb:min-w-[104vw]  min-w-[52vw] items-center flex gap-5 '>
...
<div  className=' mb:mt-0 mt-[7%] flex mb:h-[19rem] mb:w-[12.5rem] flex-col gap-5  w-[25vw] h-[80vh] '>
...
<img className={`${transYImg3} mb:hidden `} src={"https://live.staticflickr.com/65535/52253442753_082b153f22_o.png"} alt="" />

</div>
       </div>
       <div className=' mb:h-[19rem] min-w-[52vw] mb:min-w-[156vw] items-center flex gap-5 '>
      ...
      <div  className=' mb:h-[19rem] mb:mt-0 mb:flex mb:w-[50vw] mb:flex-row mt-[7%] flex flex-col gap-5  w-[25vw] h-[80vh] '>
